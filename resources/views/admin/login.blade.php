        ...
        <div id="login" class="animate form">
            <section class="login_content">
                {!! Form::open(['url' => 'auth/login', 'method' => 'post', 'role' => 'form']) !!}
                    <h1>Login</h1>
                    <div>
                        <input type="text" id="log" name="log" class="form-control" placeholder="Username" required="" />
                    </div>
                    <div>
                    ...
                    <div class="separator">
                        ...
                        <br />
                        <div>
                            <h1><i class="fa fa-paw" style="font-size: 26px;"></i> Laravel Admin</h1>
                            <p>© 2016 Laravel Admin. All Rights Reserved.</p>
                        </div>
                    </div>
                {!! Form::close() !!}
                <!-- form -->
